...
using IResult = E_CommerceSystem.Entities.Utilities.Results.Abstarct.IResult;
...
namespace E_CommerceSystem.BLL.Servicess.Implementations
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<IDataResult<string>> SignUp(UserCreateDTO dto, string role)
        {
        ...
        public async Task<IResult> Update(UserUpdateDTO dto)
        {
